...
checkpoint BJ_extract_joints_df:
    ...
    output:
        dfl="results/{dset}/backbone_joints/edge_len.csv",
        dfc="results/{dset}/backbone_joints/edge_count.csv",
    params:
...
rule BJ_extract_joints_pos:
    ...
    output:
        pos="results/{dset}/backbone_joints/joints_pos.json",
    conda:
        "../conda_env/bioinfo.yml"
    shell:
        """
...
#     output:
#         paths="results/{dset}/backbone_joints/raw_paths.json",
#     conda:
#         "../conda_env/bioinfo.yml"
#     shell:
#         """
...
rule BJ_extract_pangenome_info:
    ...
    output:
        info="results/{dset}/backbone_joints/edge_pangenome.csv",
    conda:
        "../conda_env/bioinfo.yml"
    shell:
        """
...
rule BJ_extract_joint_sequence:
    ...
    output:
        seq="results/{dset}/backbone_joints/joints_seqs/{edge}.fa",
    conda:
        "../conda_env/bioinfo.yml"
    shell:
        """
...
rule BJ_pangraph:
    ...
    output:
        pan="results/{dset}/backbone_joints/joints_pangraph/{edge}.json",
    params:
...
rule BJ_junct_stats:
    ...
    output:
        stats="results/{dset}/backbone_joints/junctions_stats.csv",
    conda:
        "../conda_env/bioinfo.yml"
    shell:
        """
...
rule BJ_aln_position:
    ...
    output:
        SNPs="results/{dset}/backbone_joints/j_aln_pos/SNPs.csv",
        junct_pos="results/{dset}/backbone_joints/j_aln_pos/junct_pos.csv",
        aln_pos="results/{dset}/backbone_joints/j_aln_pos/aln_pos.csv",
    params:
...
#         seq=rules.BJ_extract_joint_sequence.output.seq,
#     output:
#         dist="results/{dset}/backbone_joints/dist/mash/{edge}.csv",
#     conda:
#         "../conda_env/bioinfo.yml"
#     shell:
#         """
...
#     output:
#         fig="figs/{dset}/backbone_joints/joints_linear_plot/{edge}.png",
#     conda:
#         "../conda_env/bioinfo.yml"
#     shell:
#         """
...
rule BJ_all:
    input:
        expand(rules.BJ_extract_pangenome_info.output, dset=dset_names),
        expand(rules.BJ_junct_stats.output, dset=dset_names),
        expand(rules.BJ_aln_position.output, dset=dset_names),
