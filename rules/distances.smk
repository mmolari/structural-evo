...
rule DST_corealignment:
    ...
    output:
        "results/{dset}/distances/coredivergence.csv",
    params:
...
rule DST_filtered_corealignment:
    ...
    output:
        "results/{dset}/distances/coredivergence-filtered.csv",
    params:
...
rule DST_pangraph:
    ...
    output:
        "results/{dset}/distances/pangraph.csv",
    conda:
        "../conda_env/bioinfo.yml"
    shell:
        """
...
rule DST_pangraph_nodupl:
    input:
        rules.PG_polish.output,
    output:
        "results/{dset}/distances/pangraph-nodupl.csv",
    conda:
        "../conda_env/bioinfo.yml"
    shell:
        """
...
rule DST_edge:
    input:
        rules.PG_polish.output,
    output:
        "results/{dset}/distances/pangraph_edge_distance.csv",
    params:
        len_thr=100,
    conda:
        "../conda_env/bioinfo.yml"
...
rule DST_blocks:
    input:
        rules.PG_polish.output,
    output:
        "results/{dset}/distances/pangraph_block_distance.csv",
    params:
        len_thr=100,
    conda:
        "../conda_env/bioinfo.yml"
...
rule DST_merge:
    ...
    output:
        "results/{dset}/distances/summary.csv",
    conda:
        "../conda_env/bioinfo.yml"
    shell:
        """
...
rule DST_all:
    input:
        expand(rules.DST_merge.output, dset=dset_names),
        expand(rules.DST_pangraph_nodupl.output, dset=dset_names),
